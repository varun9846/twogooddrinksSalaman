        ...
        <div className="grid gap-10 lg:grid-cols-3">
          ...
          <div className="space-y-8">
            ...
            {/* <div className="rounded-[24px] border border-[#eef0f4] bg-white p-6 md:p-8 shadow-[0_8px_30px_rgb(0,0,0,0.04)] sticky top-8">
              ...
              <form onSubmit={handleCalculate} className="space-y-5">
                <div>
                  ...
                  <input
                    ...
                    placeholder="e.g., 160"
                    className="h-12 w-full rounded-xl border border-[#e2e8f0] bg-[#f8f9fa] px-4 text-[15px] text-[#2b2b2d] outline-none transition-all duration-200 placeholder:text-[#94a3b8] focus:border-[#0f766e] focus:bg-white focus:ring-4 focus:ring-[#0f766e]/10"
                    required
                  />
                </div>
                <button
                  type="submit"
                  className="h-12 w-full rounded-xl bg-[#0f766e] text-[15px] font-semibold text-white shadow-lg shadow-[#0f766e]/20 transition-all duration-300 hover:bg-[#5a6fc9] hover:shadow-xl hover:shadow-[#0f766e]/30 active:scale-[0.98]"
                >
                  Calculate Targets
                </button>
              </form>
              ...
              {calculatedOz !== null && (
                <div className="mt-6 rounded-2xl bg-gradient-to-br from-[#0f766e]/5 to-[#0f766e]/10 p-5 border border-[#0f766e]/20 text-center animate-in fade-in zoom-in duration-300">
                  <p className="text-[13px] font-medium text-[#686e7d] uppercase tracking-wide">Your Recommended Baseline</p>
                  <p className="text-[36px] font-extrabold text-[#0f766e] mt-1 leading-none">
                    {calculatedOz} <span className="text-[16px] font-semibold text-[#2b2b2d]">oz / day</span>
                  </p>
                  <p className="text-[13px] text-[#686e7d] mt-3 bg-white/60 inline-block px-3 py-1 rounded-full border border-[#0f766e]/10">
